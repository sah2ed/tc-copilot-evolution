...
* reviewiers [5][6] and;
* copilots (known as facilitators in granted patents) [5][6];
...
5. Topcoder patent on the development track: [Systems and methods for software development](https://patents.justia.com/patent/7778866), Jan 14, 2005 - Topcoder, Inc. 

6. Topcoder patent on the design track: [Systems and methods for graphic design development](https://patents.justia.com/patent/8209238), Jun 23, 2010 - TopCoder, Inc. 

7. Topcoder patent on submission screening: [Systems and methods for screening submissions in production competitions](https://patents.justia.com/patent/10783458), May 1, 2006 - TopCoder, Inc. 
